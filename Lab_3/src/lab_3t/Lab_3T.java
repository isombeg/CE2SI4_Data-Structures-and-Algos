...
public class Lab_3T {
    ...
    public static void main(String[] args) {
        int
                a[] = {23,45,2352,-3,245,2,3,56,2,87,10000},
                b[] = {23,62,7,2,763,15,832,72,7};
        
        BSTSet 
                a_Set = new BSTSet(a),
                b_Set = new BSTSet(b),
                set3 = a_Set.union(b_Set),
                set4 = b_Set.union(a_Set),
                set5 = set3.intersection(a_Set),
                set6 = b_Set.intersection(set4),
                set7 = set3.difference(a_Set),
                set8 = set3.difference(b_Set);
...
//        a_Set.remove(3);
        ...
        //Class testcases
        System.out.println("Official testcases:");
